  ...
  return (
    ...
    <div className="w-5/6 mx-auto">
      ...
      <div className=" p-20 pt-10  ">
        ...
        NSHMC offers a variety of venues suitable for different purposes, including lectures, seminars, conferences, and personal events. Below, you`'`ll find details about each venue, including their capacity and associated rules.
        </p>
      </div>
